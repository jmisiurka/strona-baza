...
<div class="container">
  ...
  <form name="form" action="wybor_zestawu.php" method="post">
    ...
    <?php
      ...
      <option value="<?php echo $tool_type["tool_type"]?>"><?php echo $tool_type["tool_type"] ?></option>
      <?php } ?>
...
?>
  ...
  <form name="form" action="wybor_mat.php" method="post">
    <select name="materiał">
      ...
      <option value="<?php echo $material["materiał"]?>"><?php echo $material["materiał"] ?></option>
      <?php } ?>
...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) { ?>
	 ...
	 <tr>
		<td width="70" align="center"><img src="foto/<?php echo $row["foto"] ?>" height="70" width="70" border="0" alt="[Rozmiar: 4189 bajtów]"></td>
		...
		<td width = "80 "> <?php echo $row["materiał"]; ?></td>
